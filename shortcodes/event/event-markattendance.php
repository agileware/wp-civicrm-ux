 ...
 */
class Civicrm_Ux_Shortcode_Event_MarkAttendance extends Abstract_Civicrm_Ux_Shortcode {
	/**
	 * @return string The name of shortcode
	 */
	public function get_shortcode_name() {
		return 'ux_event_markattendance';
	}
	...
	public function shortcode_callback( $atts = [], $content = null, $tag = '' ) {
        ...
        $error_message =    '<div class="event-markattendance-error" style="display:none;">
