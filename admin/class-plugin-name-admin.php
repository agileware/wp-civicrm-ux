...
class Agileware_Civicrm_Utilities_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->agileware_civicrm_utilities, plugin_dir_url( __FILE__ ) . 'css/agileware-civicrm-utilities-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->agileware_civicrm_utilities, plugin_dir_url( __FILE__ ) . 'js/agileware-civicrm-utilities-admin.js', array( 'jquery' ), $this->version, false );
